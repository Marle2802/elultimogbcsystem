                ...
                <div class="card shadow">
                    ...
                    <div class="row card-body">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" placeholder="Ingrese el nombre del domo"
                                name="nombre" required>
                        </div>

                        <div class="form-group col-6">
                            <label for="capacidad">Descripción</label>
                            <textarea class="form-control" name="descripcion" placeholder="Ingrese una descripción" rows="2" required>
                    ...
                    $("#tblCaracteristicas").append(`
                            <tr id="tr-${caracteristica_id}">
                                ...
                                <td>
                                    ...
                                    onclick="eliminar_caracteristica(${caracteristica_id})"><i class="fa-solid fa-trash">
                                        </i></button>
                                </td>
                            <tr>
                        `);
