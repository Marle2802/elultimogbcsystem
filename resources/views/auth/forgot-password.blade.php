...
<head>
    ...
    <title>GBC System Recuperar contraseña</title>
            ...
            <div class="col-xl-10 col-lg-10 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img class="col-lg-7 d-none d-lg-block" src="https://domusglamping.com/wp-content/uploads/2022/04/DJI_0864-v2-1536x863.jpg" >
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <a class="underline text-sm text-gray-600 hover:text-gray-900"
                                            href="{{ route('login') }}">
                                            {{ __('¿Ya tienes una cuenta? ¡Acceso!') }}
                                        </a>
                                    </div>
                                </div>
                            </div>
