...
<html lang="en">
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(90deg, #36d4ca 0%, #daae51 100%);
      }
    </style>
  </head>
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Sobre nosotros</a>
            </li>
            <li class="mr-3">
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Vive una aventura y crea experiencias increibles!
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Animate a salir de la rutina y ven a disfrutar con ROYAL GLAMPING!
          </p>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="https://cf.bstatic.com/xdata/images/hotel/max1280x900/383970777.jpg?k=9cff4491016868546fee2d7c126670b903a454e8503048c5dc64e8404e6b8cd0&o=&hp=1" />
        </div>
      </div>
    </div>
    <div class="relative -mt-12 lg:-mt-24">
      <svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="hero">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
                Empresa dedicada a ofrecer la experiencia de acampar al aire libre con condiciones de lujo en su lugar de campamento o domo, donde se ofrecen servicios o paquetes adicionales de hospedaje, para el disfrute de nuestros clientes.
              <br />
              <br />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Como llegar a ROYAL GLAMPING
              </h3>
              <nav >
                <center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126857.04890085799!2d-75.0196081!3d6.4858293!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e440b3e50b0c467%3A0x10bb1ca78cbae1d1!2sGlamping%20Paraiso%20San%20Roque%20Antioquia!5e0!3m2!1ses!2sco!4v1670301734394!5m2!1ses!2sco" width="900" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></center>
            </nav>
      ...
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
          ...
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Jacuzzi privado <br>
                Amplio balcón con comedor.<br>
                Comida<br>
                Fogata con malvaviscos. <br>
                Uso de áreas comunes, naturales<br>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                <img class="w-full md:w-4/5 z-50" src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/380179185.jpg?k=8b93dafeeb4cac80912870d88661db9b5f2c5018d9d4069c6d6e8da9d8184993&o=&hp=1" />
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              <p class="w-full text-gray-600 text-xs md:text-sm px-6">
                <img class="w-full md:w-4/5 z-50" src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/380182657.jpg?k=444e0d42b0b2f95b6de05dd16a6a8258e706d4ae9a5b77e0fd99b4188b334534&o=&hp=1" />
              </p>
              <div class="w-full font-bold text-xl text-gray-800 px-6">
                Plan Familiar
              </div><br>
    ...
    <footer class="bg-white">
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            <p class="uppercase text-gray-500 md:mb-6">Nuestras redes sociales</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Facebook</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Instagran</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Booking</a>
              </li>
            </ul>
          </div>
          <div class="flex-1">
            <p class="uppercase text-gray-500 md:mb-6">Compañía</p>
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Sobre Nosotros</a>
              </li>
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Contactanos</a>
              </li>
            </ul>
          </div>
        </div>
